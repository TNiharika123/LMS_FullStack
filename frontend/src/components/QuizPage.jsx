...
import {
  ...
  Select, InputLabel, FormHelperText, Chip, Fade, Zoom,
  IconButton, Stepper, Step, StepLabel, useTheme, Tooltip
} from '@mui/material';
import {
  ArrowBack, ArrowForward, PlayArrow, Check, Close,
  Warning, Timer, Assignment, Code, CodeOff
  ...
  const handleRunCode = async () => {
    ...
    if (selectedLanguage === "javascript") {
      ...
      try {
        ...
        setScore(response.data.passed ? 100 : 0);
