      ...
      >
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', position: 'relative', zIndex: 1, color: 'white' }}>
            ...
            >
              Unlock Your Potential<br />with LearnSphere
            </Typography>
            <Typography 
              variant="h5" 
              component={motion.p}
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 8 }}>
            ...
            <Typography 
              ...
              variants={fadeInUp}
            >
              Get started with LearnSphere in three simple steps
            </Typography>
          </Box>
            ...
            {[
              {
                ...
                quote: "LearnSphere completely transformed my career path. The courses are comprehensive and the instructors are incredibly knowledgeable. I went from knowing basic coding to landing my dream job in just 6 months!"
              },
              {
                name: "Sarah Williams",
                role: "Data Scientist",
                image: "/api/placeholder/80/80",
                quote: "The data science track on LearnSphere provided me with all the skills I needed to transition into the field. The community support and career guidance were invaluable additions to the excellent course content."
              },
              {
                name: "Michael Chen",
                role: "UX Designer",
                image: "/api/placeholder/80/80",
                quote: "As someone who learns best by doing, I appreciated the hands-on approach of LearnSphere courses. The projects were challenging but rewarding, and I built a portfolio that impressed employers right away."
              }
            ].map((testimonial, idx) => (
            ...
            <Grid item xs={12} md={4}>
              ...
              <Box sx={{ display: 'flex', gap: 1.5 }}>
                ...
                <IconButton 
                  ...
                  size="small"
                  href="mailto:info@learnsphere.com"
                >
