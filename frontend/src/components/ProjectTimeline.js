...
const ProjectManagement = ({ initialTab = 0 }) => {
      ...
      <Box>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
          ...
          <Box>
            ...
            >
              <MenuItem onClick={() => { setSortBy('dueDate'); handleSortClose(); }}>
                Due Date
              </MenuItem>
              <MenuItem onClick={() => { setSortBy('priority'); handleSortClose(); }}>
                Priority
              </MenuItem>
              <MenuItem onClick={() => { setSortBy('status'); handleSortClose(); }}>
                Status
              </MenuItem>
              <MenuItem onClick={() => { setSortBy('title'); handleSortClose(); }}>
                Title
              </MenuItem>
            </Menu>
  ...
  //                 <Box sx={{ mt: 2 }}>
  //                   <Typography variant="subtitle2" gutterBottom>Current Tasks</Typography>
  //                   <Typography>
  //                     {tasks.filter(t => t.assigned.includes(user.id) && t.status !== 'completed').length}
  //                   </Typography>
  //                 </Box>
  //               </CardContent>
              ...
              <List>
                <ListItem>
                  <ListItemText
                    ...
                    secondary="Enable email notifications for task assignments and updates"
                  />
                  <ListItemSecondaryAction>
                ...
                <ListItem>
                  <ListItemText
                    primary="Theme"
                    secondary="Change application theme and appearance"
                  />
                  <ListItemSecondaryAction>
                    <Button variant="contained">Select Theme</Button>
                  </ListItemSecondaryAction>
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="Default View"
                    secondary="Set your default project view"
                  />
                  <ListItemSecondaryAction>
                    <FormControl variant="outlined" size="small" sx={{ minWidth: 120 }}>
                      ...
                      >
                        ...
                        <MenuItem value="gantt">Timeline</MenuItem>
                      </Select>
                    </FormControl>
                  </ListItemSecondaryAction>
                </ListItem>
              ...
              <List>
                <ListItem>
                  <ListItemText
                    ...
                    secondary="Update your name, email and other details"
                  />
                  <ListItemSecondaryAction>
              ...
              <List>
                <ListItem>
                  <ListItemText
                    ...
                    secondary="Manage team members and their permissions"
                  />
                  <ListItemSecondaryAction>
                    <Button variant="contained">Manage Team</Button>
                  </ListItemSecondaryAction>
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="Project Templates"
                    secondary="Create and manage project templates"
                  />
                  <ListItemSecondaryAction>
                    <Button variant="contained">Configure Templates</Button>
                  </ListItemSecondaryAction>
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="Integrations"
                    secondary="Connect with other tools and services"
                  />
                  <ListItemSecondaryAction>
                    <Button variant="contained">Configure Integrations</Button>
                  </ListItemSecondaryAction>
                </ListItem>
              </List>
            </Paper>
    ...
    <Box sx={{ display: 'flex', height: '100vh' }}>
      ...
      <MainContent>
        <Container maxWidth="xl">
          ...
          {/* {currentTab === 3 && renderTeamMembers()} */}
          {currentTab === 3 && renderReports()}
          {/* {currentTab === 4 && renderSettings()} */}
        </Container>
      </MainContent>
